...
# import Draw cylinder function 
#import DrawCylinder
#imp.reload(DrawCylinder)
#from DrawCylinder import *
...
def cylinder_between(x1, x2, r):
    ...
    #bpy.context.object.modifiers["Decimate"].ratio = 10
    #bpy.context.object.modifiers["Decimate"].decimate_type = 'UNSUBDIV'
    #bpy.context.object.modifiers["Decimate"].iterations = 0
    #bpy.context.object.modifier_apply(apply_as='DATA', modifier="Decimate")
    phi = math.atan2(dy, dx) 
    theta = math.acos(dz/dist) 
    bpy.context.object.rotation_euler[1] = theta 
    bpy.context.object.rotation_euler[2] = phi
    #bpy.ops.mesh.primitive_uv_sphere_add(radius=r, enter_editmode=False, location=x1)
    #bpy.ops.mesh.primitive_uv_sphere_add(radius=r, enter_editmode=False, location=x2)
